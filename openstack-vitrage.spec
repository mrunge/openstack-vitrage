...
BuildRequires:    python-keystonemiddleware >= 2.2.0
...
BuildRequires:    python-novaclient >= 2.26.0
BuildRequires:    python-heatclient >= 1.5.0
...
%package -n python-vitrage-tempest-tests
Summary:        Vitrage tempest tests
Requires:       python-vitrageclient

%description -n python-vitrage-tempest-tests
OpenStack vitrage provides API and services for RCA (Root Cause Analysis).

This package contains the files required to run tempest on vitrage.
...
%check
# check requires python-vitrageclient (rhbz#1379786)
...
%files -n python-vitrage-tempest-tests
%license LICENSE
